...
class ExtractPluginCommand extends VanillaCommand{
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		if(count($args) === 0){
			$sender->sendMessage(TextFormat::RED . "Kullanış: ".$this->usageMessage);
			return true;
		}
		...
		$folderPath = Server::getInstance()->getPluginPath().DIRECTORY_SEPARATOR . "DarkSystem" . DIRECTORY_SEPARATOR . $description->getName()."_v".$description->getVersion()."/";

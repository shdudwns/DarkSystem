...
use pocketmine\entity\{Arrow, BlazeFireball, Camera, Car, Item as DroppedItem, Egg, EnderCrystal, EnderPearl, FallingSand, FishingHook, GhastFireball, LeashKnot, Lightning, Minecart, MinecartChest, MinecartHopper, MinecartTNT, Painting, PrimedTNT, Snowball, ThrownExpBottle, ThrownPotion, XPOrb, Herobrine, Human, Bat, BlueWitherSkull, Boat, Dragon, Donkey, ElderGuardian, EnderDragon, Endermite, EvocationFangs, Giant, Guardian, Horse, Husk, LavaSlime, Llama, MagmaCube, Mule, PolarBear, Shulker, ShulkerBullet, Slime, SkeletonHorse, Stray, Squid, Vex, Villager, Vindicator, Witch, Wither, WitherSkeleton, ZombieHorse};
